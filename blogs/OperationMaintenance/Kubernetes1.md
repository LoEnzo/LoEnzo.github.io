...
**Kubernetes**是一个开源的，用于管理云平台中多个主机上的容器化的应用，**Kubernetes**的目标是让部署容器化的应用简单并且高效（powerful）,Kubernetes提供了应用部署，规划，更新，维护的一种机制。根据[哔哩哔哩黑马视频](https://www.bilibili.com/video/BV1cK4y1L7Am?p=1)学习，学习来源于搬迁，部分文档有根据自己学习进行修改和补充，[文档学习资源](https://www.orchome.com/1786)
...
![image-20200505183738289](./images/k8s/image-20200505183738289.png)
...
<img src="./images/k8s/image-20200524150339551.png" alt="image-20200524150339551" style="border:1px solid;zoom:110%;" />

## kubernetes简介

<img src="./images/k8s/image-20200406232838722.png" alt="image-20200406232838722" style="zoom:100%;border:1px solid;" />
...
![image-20200526203726071](./images/k8s/image-20200526203726071.png)
...
<img src="./images/k8s/image-20200406184656917.png" alt="image-20200406184656917" style="zoom:200%;" />
...
<img src="./images/k8s/image-20200403224313355.png" alt="image-20200403224313355" style="zoom:200%;" />
...
![image-20200404094800622](./images/k8s/image-20200404094800622.png)
...
- 网络配置：按照下面配置网路地址信息
  ...
  ![image-20200505213817934](./images/k8s/image-20200505213817934.png)
...
- 主机名设置：按照下面信息设置主机名
  ...
  ![image-20200505214156148](./images/k8s/image-20200505214156148.png)
