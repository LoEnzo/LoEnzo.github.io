...
本章主要学习K8s组件之一pod，包含齐基本介绍、结构、定义、配置、相关命令、生命周期、调度等。根据[哔哩哔哩黑马视频](https://www.bilibili.com/video/BV1cK4y1L7Am?p=1)学习，学习来源于搬迁，部分文档有根据自己学习进行修改和补充，[文档学习资源](https://www.orchome.com/1786)
...
<img src="./images/k8s/image-20200412111402706.png" alt="image-20200412111402706" style="border:solid 1px" />
...
6. apiServer将接收到的pod状态信息存入etcd中
   ...
   <img src="./images/k8s/image-20200406184656917.png" alt="image-20200406184656917" style="zoom:100%;" />
...
<img src="./images/k8s/image-20200605021831545.png" alt="image-20200605021606508" style="border:1px solid" />
...
![image-20200514095913741](./images/k8s/image-20200514095913741.png)
